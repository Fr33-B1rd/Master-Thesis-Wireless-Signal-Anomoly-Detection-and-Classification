...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Tuned AAE.")
    parser.add_argument("--dataset", default="16QAM", help="Dataset name.")
    parser.add_argument("--run", default="tuned_run", help="Run name.")
    parser.add_argument("--epochs", type=int, default=100, help="Number of training epochs.")
    parser.add_argument("--lr", type=float, default=1e-5, help="Learning rate (Tuned to 1e-5).")
...
def main():
    ...
    OUT_DIR = os.path.join(".", "runs", f"{dataset_name}_aae_tuned_{run_name}")
    ...
    # Initialize Model
    print(f"Initializing AAE with Tuned Settings...")
