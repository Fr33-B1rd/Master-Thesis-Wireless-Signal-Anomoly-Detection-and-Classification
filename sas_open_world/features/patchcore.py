...
from support.fewshot_patchcore_classifier_sas import build_semantic_feature
...
def build_feature_cache(
    ...
    raw_images = None
    if augment_temporal_diff or augment_dynamic_range or augment_entropy or augment_frequency_profile:
        raw_images = np.load(os.path.join(dataset_dir, "test_spectrogram.npy"), mmap_mode="r")
